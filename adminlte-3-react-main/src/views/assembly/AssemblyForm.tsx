...
const AssemblyForm = ({
  ...
  const formik = useFormik<IAssemblyFormValues>({
    initialValues,
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-6 mt-4 border-t border-gray-100 dark:border-gray-800">
            <Button
              ...
              disabled={loading}
              className="dark:bg-[#202123] dark:border-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all font-medium"
            >
              Cancel
            </Button>
            <Button
